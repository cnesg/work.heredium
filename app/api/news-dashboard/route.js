...
const SOURCES = [
  ...
  },
  {
    ...
    label: "한경",
    category: "music",
    url: `https://docs.google.com/spreadsheets/d/${process.env.MUSIC_NEWS_SHEET_ID || "1Fkmoxy8cdklyE_elwEfMf5PH1ML2yJYvgM_xSiaug8c"}/export?format=csv&gid=1232610534`,
    map: (r) => ({
      loadedAt: r["적재일"] || "",
      publishedAt: r["기사발행일"] || "",
      press: r["보도언론사"] || "",
  ...
  },
  {
    ...
    label: "다음 음악",
    category: "music",
    url: `https://docs.google.com/spreadsheets/d/${process.env.MUSIC_NEWS_SHEET_ID || "1Fkmoxy8cdklyE_elwEfMf5PH1ML2yJYvgM_xSiaug8c"}/export?format=csv&gid=770325408`,
    map: (r) => ({
      loadedAt: r["적재일"] || "",
      publishedAt: r["기사발행일"] || "",
      press: r["보도언론사"] || "",
  ...
  },
  {
    ...
    label: "문화일보 공연",
    category: "music",
    url: `https://docs.google.com/spreadsheets/d/${process.env.MUSIC_NEWS_SHEET_ID || "1Fkmoxy8cdklyE_elwEfMf5PH1ML2yJYvgM_xSiaug8c"}/export?format=csv&gid=1130980641`,
    map: (r) => ({
      loadedAt: r["적재일"] || "",
      publishedAt: r["기사발행일"] || "",
      press: r["보도언론사"] || "",
